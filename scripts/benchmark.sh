...
# Author: Mehak Sayed Yusuf (USN: 01FE24BCI012, Division: B, Roll No: 202)
...
lscpu | grep -E "Model name|CPU\(s\)|Thread\(s\) per core|Core\(s\) per socket|Socket\(s\)|Hypervisor" | tee -a "$OUTPUT_FILE"
